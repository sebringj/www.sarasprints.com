...
(function () {
    ...
    $('[data-passwordreset] form').submit(function(ev){
        ev.preventDefault();
        emeraldcode.ready(function(){
            emeraldcode.login({
                ...
                $('[data-signin]').find('.alert').hide();
                emeraldcode.handleLoginState();
                if (data.success) {
                     handleLogin();
                } else {
                    $('[data-signin]').find('.alert').show();
                }
            });
        });
    });

    $('[data-signin] form').on('focus click','input', function(){
        $('[data-signin]').find('.alert').hide();
    });
